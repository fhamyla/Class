...
export function AttendanceHistory({
  ...
  const presentCount = Object.values(currentRecords).filter(
    (s) => s === "present",
  ).length;
  const absentCount = Object.values(currentRecords).filter(
    (s) => s === "absent",
  ).length;
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-3 border border-warm-gray rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-sage focus:border-sage sm:text-sm"
            />
          </div>
        </div>
      </Card>
